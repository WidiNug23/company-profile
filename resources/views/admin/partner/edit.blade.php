    ...
    <form action="{{ route('partners.update', $partner->partner_id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="partner_name" name="partner_name" value="{{ old('partner_name', $partner->partner_name) }}" required placeholder="Masukkan nama partner">
            </div>
            ...
            <div class="form-group">
                ...
                @if($partner->logo)
                    <img src="{{ asset('storage/'.$partner->logo) }}" width="80" style="object-fit:cover; border-radius:6px; margin-top:10px;">
                @endif
            </div>
        </div>
        ...
        <!-- <div class="form-group">
            ...
            <div id="editor">{!! old('description', $partner->description) !!}</div>
...
// Set initial value dari partner.description
quill.root.innerHTML = `{!! addslashes(old('description', $partner->description)) !!}`;
