...
@section('title', 'Edit Project Story')
@section('page-title', 'Edit Project Story')

@section('content')
<div class="story-wrapper">
    <div class="story-card edit-border">
        <div class="story-header">
            <div class="circle-icon edit-icon"><i class="fas fa-edit"></i></div>
            <div>
                <h3>Edit Project Story</h3>
                <p>Memperbarui narasi untuk project: <strong>{{ $project_story->project->project_name }}</strong></p>
            </div>
        </div>
        ...
        <form action="{{ route('project-stories.update', $project_story->story_id) }}" method="POST" id="editStoryForm">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <select id="project_id" name="project_id" required>
                    @foreach($projects as $project)
                        <option value="{{ $project->project_id }}" {{ old('project_id', $project_story->project_id) == $project->project_id ? 'selected' : '' }}>
            ...
            <div class="editor-grid">
                <div class="form-group">
                    ...
                    <div class="quill-wrapper">
                        <div id="challenge_editor">{!! old('challenge', $project_story->challenge) !!}</div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="quill-wrapper">
                        <div id="solution_editor">{!! old('solution', $project_story->solution) !!}</div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="quill-wrapper">
                        <div id="result_editor">{!! old('result', $project_story->result) !!}</div>
                    </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-update">
                    <i class="fas fa-sync-alt"></i> Update Story
                </button>
            </div>
        </form>
    </div>
...
<style>
    ...
    .form-group select { 
        ...
        background: var(--bg-edit); transition: 0.3s; font-size: 15px;
    }
    .form-group select:focus { border-color: var(--edit-amber); outline: none; background: white; box-shadow: 0 0 0 4px rgba(245, 158, 11, 0.1); }

    .quill-wrapper { border-radius: 12px; overflow: hidden; border: 1.5px solid var(--border); background: white; }
    .ql-toolbar.ql-snow { background: #f8fafc !important; border: none !important; border-bottom: 1px solid var(--border) !important; padding: 10px !important; }
    ...
    .btn-update { 
        background: linear-gradient(135deg, #f59e0b, #d97706); color: white; border: none; padding: 12px 35px; 
...
<script>
    ...
    document.getElementById('editStoryForm').onsubmit = function () {
