...
@section('content')
<div class="card">
    <h2 class="card-title">Edit Project Story</h2>
    ...
    <form action="{{ route('project-stories.update', $project_story->story_id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-actions">
            <button type="submit">Update Project Story</button>
        </div>
    </form>
