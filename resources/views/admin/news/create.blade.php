    ...
    <form method="POST" action="{{ route('news.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="judul" name="judul" value="{{ old('judul') }}" required placeholder="Masukkan judul berita">
            </div>

            <div class="form-group">
                <label for="jenis_berita">Jenis Berita</label>
                <input type="text" id="jenis_berita" name="jenis_berita" value="{{ old('jenis_berita') }}" required placeholder="Contoh: Berita, Artikel, Pengumuman">
            </div>

            <div class="form-group">
                <label for="author">Author</label>
                <input type="text" id="author" name="author" value="{{ old('author') }}" required placeholder="Nama penulis">
            </div>
        </div>
