...
<div class="service-form-wrapper">
    <div class="service-card">
        ...
        <div class="service-header">
            ...
            <p>Tambahkan layanan baru yang ditampilkan di website</p>
        </div>
        ...
        <form method="POST" action="{{ route('services.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <label class="icon-upload">
                    <img id="iconPreview"
                         src="https://via.placeholder.com/64?text=Icon">
                    <div class="icon-text">
                        Klik untuk upload icon (PNG / JPG / SVG)
                    </div>
                    <input
                        type="file"
                        name="icon"
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-save">Simpan Service</button>
            </div>
